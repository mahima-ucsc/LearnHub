...
<head>
    ...
    <title>Assignment View - Student</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="assignment-header">
            ...
            <div class="meta-info">
                <div class="meta-item">
                    <span>📅 Due:</span>
                    <span>Friday, January 24, 2025, 11:59 PM</span>
                </div>
                <div class="meta-item">
                    <span>💯 Points:</span>
                    <span>100</span>
        ...
        <div class="section">
            ...
            <div class="description">
                This is where the assignment description and instructions will appear.
            </div>
        </div>
    ...
    <script>
        ...
        document.querySelector('.title').textContent = "Final Project Submission";
        document.querySelector('.description').textContent =
            "Please submit your final project files including source code and documentation. Make sure to follow the formatting guidelines provided in the template.";
    </script>
</body>
